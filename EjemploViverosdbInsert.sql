...
INSERT INTO Empleado (nombre, primer_apellido, segundo_apellido, fecha_ingreso, tarea, dni, codigo_vivero) VALUES 
('Juan', 'Pérez', 'González', '2015-06-23', 'DNI1234567', 1),
('María', 'López', 'Ramírez', '2017-03-19', 'DNI2345678', 1),
('Pedro', 'Martínez', 'Santos', '2018-01-11', 'DNI3456789', 2),
('Lucía', 'García', 'Hernández', '2019-09-15', 'DNI4567890', 3),
('Ana', 'Mendoza', 'Quispe', '2020-05-02', 'DNI5678901', 4);

-- Insertar datos en Historico_puesto
INSERT INTO Historico_puesto (codigo_empleado, puesto, fecha) VALUES 
(1, 'Gerente', '2015-06-23'),
(1, 'Supervisor', '2016-09-01'),
(2, 'Operador', '2017-03-19'),
(3, 'Jefe de Zona', '2018-01-11'),
(4, 'Supervisor', '2019-09-15');
...
-- Insertar datos en Empleado_Zona
INSERT INTO Empleado_Zona (codigo_vivero, codigo_empleado, codigo_zona) VALUES 
